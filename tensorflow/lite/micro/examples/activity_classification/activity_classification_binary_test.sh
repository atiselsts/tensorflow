...
${TEST_SRCDIR}${SCRIPT_BASE_DIR}/tensorflow/lite/micro/examples/activity_classification   2>&1 | head > ${OUTPUT_LOG_FILE}
...
echo
echo "SUCCESS: activity_classification_binary_test PASSED"

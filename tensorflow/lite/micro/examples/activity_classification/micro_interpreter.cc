...
TfLiteStatus MicroInterpreter::AllocateTensors() {
  lcd.DisplayStringAt(0, LINE(5), (uint8_t *)"AllocateTensors", CENTER_MODE);
  ...
  lcd.DisplayStringAt(0, LINE(6), (uint8_t *)"started ok", CENTER_MODE);
  ...
  lcd.DisplayStringAt(0, LINE(7), (uint8_t *)"init nodes", CENTER_MODE);
  ...
  lcd.DisplayStringAt(0, LINE(8), (uint8_t *)"prepare nodes", CENTER_MODE);
  ...
  lcd.DisplayStringAt(0, LINE(9), (uint8_t *)"finish", CENTER_MODE);
